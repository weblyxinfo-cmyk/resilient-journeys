...
const CookieBanner = () => {
  ...
  return (
    <div id="cms-shared-cookiebanner" className="fixed bottom-0 inset-x-0 z-[60] p-4 md:p-6">
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <p className="text-sm font-sans text-foreground mb-1 font-medium">
              {t("cookiebanner_title", "We use cookies")}
            </p>
            <p className="text-sm font-sans text-muted-foreground mb-4">
              {t("cookiebanner_text", "We use cookies to improve your experience. Non-essential cookies are only used with your consent.")}{" "}
              <Link to="/cookies" className="text-gold hover:underline">
                {t("cookiebanner_link_learn_more", "Learn more")}
              </Link>
            </p>
            <div className="flex gap-3">
              ...
              >
                {t("cookiebanner_button_accept", "Accept All")}
              </Button>
              <Button
              ...
              >
                {t("cookiebanner_button_decline", "Essential Only")}
              </Button>
            </div>
          </div>
        </div>
