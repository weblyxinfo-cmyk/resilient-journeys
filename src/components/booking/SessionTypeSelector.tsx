...
export const SessionTypeSelector = ({
  ...
  const getDefaultSessionTypes = (): SessionType[] => [
    ...
    },
    {
      ...
      description: '3-Session Holistic Support Package. A structured three-session journey designed to build emotional resilience while living with endometriosis or chronic pain.',
